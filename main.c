...
{
   writeText(2, 8, "L4A GLCD");
   writeText(3, 8, "--------");
   writeText(4, 2, "Marcel Alabart Benoit");
   writeText(5, 2, "Aron Moreno Victoria");
   __delay_ms(2000);
...
void main(void)
{
   ...
   {   
      if (PORTEbits.RE0 && !b) {
		...
		clearGLCD(0,0,0,127);
		writeText(4, 8, "00:00:00.0");
		writeText(0, 0, "Press RE0 to start");
		}
	    __delay_ms(2);
      }
